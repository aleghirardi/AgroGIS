...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    public frmPrincipal() {
        ...
        MenuConsultarInicio.setEnabled(false);
...
//        this.setExtendedState(this.MAXIMIZED_BOTH);
 ...
 public Image getIconImage(){
    ...
    private void initComponents() {
        ...
        MenuConsultarInicio = new javax.swing.JMenu();
        ItemVerPais = new javax.swing.JMenuItem();
        ItemVerProvincia = new javax.swing.JMenuItem();
        ItemVerDepto = new javax.swing.JMenuItem();
        ItemVerLocalidad = new javax.swing.JMenuItem();
        ItemVerBarrio = new javax.swing.JMenuItem();
        ItemVerEspecialidad = new javax.swing.JMenuItem();
        ...
        MenuConsultarInicio.setText("Consultar / Modificar");
        MenuConsultarInicio.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N

        ItemVerPais.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ItemVerPais.setText("Pais");
        MenuConsultarInicio.add(ItemVerPais);

        ItemVerProvincia.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ItemVerProvincia.setText("Provincia");
        MenuConsultarInicio.add(ItemVerProvincia);

        ItemVerDepto.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ItemVerDepto.setText("Departamento");
        MenuConsultarInicio.add(ItemVerDepto);

        ItemVerLocalidad.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ItemVerLocalidad.setText("Localidad");
        MenuConsultarInicio.add(ItemVerLocalidad);

        ItemVerBarrio.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ItemVerBarrio.setText("Barrio");
        MenuConsultarInicio.add(ItemVerBarrio);

        ItemVerEspecialidad.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ItemVerEspecialidad.setText("Especialidad Laboratorio");
        MenuConsultarInicio.add(ItemVerEspecialidad);

        MenuInicio.add(MenuConsultarInicio);
...
private void ItemRetiroCerealActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ItemRetiroCerealActionPerformed
    ...
    private javax.swing.JMenuItem ItemVerBarrio;
    private javax.swing.JMenuItem ItemVerDepto;
    private javax.swing.JMenuItem ItemVerEspecialidad;
    private javax.swing.JMenuItem ItemVerEstacion;
    private javax.swing.JMenuItem ItemVerLab;
    private javax.swing.JMenuItem ItemVerLocalidad;
    private javax.swing.JMenuItem ItemVerPais;
    private javax.swing.JMenuItem ItemVerProvincia;
    ...
    private javax.swing.JMenu MenuConsultarInicio;
